...
export const SpaceshipEngines = memo(() => {
    ...
    return (
        <>
        <SpaceshipEngine uOpacity={uOpacity} uIntensity={uIntensity} position={[-3.5,-1.8,10.5]} />
        <SpaceshipEngine uOpacity={uOpacity} uIntensity={uIntensity} position={[3.8,-1.8,10.5]} />
        </>
    )
})
...
const SpaceshipEngine = ({uIntensity,uOpacity, position}: EngineMaterialProps) => {
    ...
    return (
        <>
        <mesh rotation={[0.07, 0, 0]} scale={[2,2.1,0.4]}
